      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('강의실 이름: $lectureRoomName', style: Theme.of(context).textTheme.headlineSmall),
            Text('과목 이름: $lectureName', style: Theme.of(context).textTheme.headlineSmall,),
            SizedBox(height: MediaQuery.of(context).size.width - 300,),
            // 출석을 진행하는 동작을 수행하는 버튼
            OutlinedButton(onPressed: onAttendance, child: Row(
